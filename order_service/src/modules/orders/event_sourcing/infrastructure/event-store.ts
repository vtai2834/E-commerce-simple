...
export class EventStore {
    ...
    async saveEvents(aggregateId: string, new_events: OrderEvent[]): Promise<void> {
        // Get current version
    ...
    async getEvents(aggregateId: string): Promise<OrderEvent[]> {
        ...
        return docs.map(doc => doc.eventData as OrderEvent);
    }

    async getAllEvents(): Promise<OrderEvent[]> {
